import type { ExecutionContext as CFExecutionContext, Request as CFRequest, DurableObjectState, DurableObjectStorage, ScheduledController, VectorizeIndex, WebSocket } from "@cloudflare/workers-types";
...
export type PartyKitServer = {
    ...
    onFetch?: (req: Request, lobby: FetchLobby, ctx: ExecutionContext) => Response | Promise<Response>;
    onSocket?(socket: FetchSocket, lobby: FetchLobby, ctx: ExecutionContext): void | Promise<void>;
    onBeforeRequest?: (req: Request, lobby: {
        id: string;
        env: Record<string, unknown>;
        ai: AI;
        parties: Context["parties"];
    ...
    onBeforeConnect?: (req: Request, lobby: {
        id: string;
        env: Record<string, unknown>;
        ai: AI;
        parties: Context["parties"];
